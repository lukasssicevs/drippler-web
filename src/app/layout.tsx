  ...
  return (
    <html lang="en" className={inter.variable}>
      <body className="font-sans antialiased min-h-screen relative bg-gradient-to-b from-neutral-950 to-fuchsia-950">
        ...
        {/* Footer */}
        <footer className="fixed bottom-0 left-0 w-full h-16 md:h-20 bg-indigo-950/20 border-t-1 border-purple-500/20 z-50">
          <div className="w-full px-4 md:px-6 h-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <PinterestLogoIcon
                size={20}
                className="text-purple-500/60 hover:text-purple-400 cursor-pointer transition-colors md:w-8 md:h-8"
              />
              <InstagramLogoIcon
                size={20}
                className="text-purple-500/60 hover:text-purple-400 cursor-pointer transition-colors md:w-8 md:h-8"
