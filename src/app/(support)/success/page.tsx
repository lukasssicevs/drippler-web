  ...
  return (
    <div className="p-8 text-center">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <p className="text-gray-400 text-sm mb-6">
              Your extension will automatically sync with your Pro status. Open the extension to start using your upgraded features.
            </p>
          </div>
        </div>
        ...
        <p className="text-gray-500 text-sm">
          Return to the Drippler extension to start creating.
        </p>
    </div>
  );
}
